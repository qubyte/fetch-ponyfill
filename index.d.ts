declare module "fetch-ponyfill" {
    export default FetchPonyfill.bootstrap;
}

declare namespace FetchPonyfill {
    export function bootstrap(options?: PonyfillCreateOptions): FetchPonyfillStatic;

    interface PonyfillCreateOptions {
        Promise?: Function;
        XMLHttpRequest?: Function;
    }

    interface FetchPonyfillStatic {
    ...
    type ResponseBodyInit = BodyInit | ReadableStream;
    interface Body {
